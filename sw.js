'use strict';
const CACHE = 'stundsOS-v3';
const ASSETS = [
  './', './index.html', './manifest.json', './css/app.css',
  './assets/icons/icon.svg', './assets/icons/icon-192.png', './assets/icons/icon-512.png',
  './js/data/holdings.js', './js/engines/ledger.js', './js/engines/prices.js',
  './js/engines/insights.js', './js/engines/projections.js',
  './js/modules/state.js', './js/modules/dashboard.js', './js/modules/portfolio.js',
