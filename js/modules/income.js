...
const Income = (() => {
  ...
  function render() {
    ...
    <div style="padding:16px;display:flex;gap:8px;">
      <button class="btn-secondary" style="flex:1;" onclick="App.openAddTransaction('SALARY')">+ Log Salary</button>
      <button class="btn-secondary" style="flex:1;" onclick="App.openAddTransaction('DIVIDEND')">+ Log Dividend</button>
    </div>
